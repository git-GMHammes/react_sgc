...
const ContratoService = {
    ...
    getEndPoint: async () => {
        const url = '/contrato/endpoint/salvar';
        let gov_br = [];
        let token_csrf = '';
        let getURI = [];
        try {
    ...
    getAll: async (page = 1, limit = 10) => {
        ...
        const url = `/contrato/api/exibir?page=${page}&limit=${limit}`;
    ...
    getById: async (id) => {
        const url = `/contrato/api/exibir/${id}`;
    ...
    postFilter: async (data, page = 1, limit = 10) => {
        ...
        const url = `/contrato/api/filtrar?page=${page}&limit=${limit}`;
