// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\services\contato.js
...
const ContatoService = {
    ...
    getAll: async (page = 1, limit = 10) => {
        ...
        const url = `/contato/api/exibir?page=${page}&limit=${limit}`;
        // console.log('url (C:/laragon/www/sgcpro/src/public/script/react_modelo_v1/frontend/src/services/contato.js):', url);
    ...
    getById: async (id) => {
        const url = `/contato/api/exibir/${id}`;
    ...
    postFilter: async (data, page = 1, limit = 10) => {
        ...
        const url = `/contato/api/filtrar?page=${page}&limit=${limit}`;
        // console.log('url (C:/laragon/www/sgcpro/src/public/script/react_modelo_v1/frontend/src/services/contato.js):', url);
