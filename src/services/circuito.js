...
const CircuitoService = {
    ...
    getEndPoint: async () => {
        const url = '/circuito/endpoint/salvar';
        let gov_br = [];
        let token_csrf = '';
        let getURI = [];
        try {
    ...
    getAll: async (page = 1, limit = 10) => {
        ...
        const url = `/circuito/api/exibir?page=${page}&limit=${limit}`;
    ...
    getById: async (id) => {
        const url = `/circuito/api/exibir/${id}`;
    ...
    postFilter: async (data, page = 1, limit = 10) => {
        ...
        const url = `/circuito/api/filtrar?page=${page}&limit=${limit}`;
