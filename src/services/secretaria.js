// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\services\secretaria.js
import axios from 'axios';
import { getBaseApi } from '../config/env';

// Obter a URL base do ambiente atual
const baseUrl = getBaseApi();
// console.log('baseUrl (C:/laragon/www/sgcpro/src/public/script/react_modelo_v1/frontend/src/services/secretaria.js):', baseUrl);
...
// Serviço para gerenciar secretarias
const SecretariaService = {
    ...
    getAll: async (page = 1, limit = 10) => {
        ...
        const url = `/secretaria/api/exibir?page=${page}&limit=${limit}`;
        ...
        try {
            ...
            if (response.data.result.dbResponse !== undefined) {
                // console.log('response.data.result.dbResponse :: ', response.data.result.dbResponse);
    ...
    getById: async (id) => {
        const url = `/secretaria/api/exibir/${id}`;
    ...
    postFilter: async (data, page = 1, limit = 10) => {
        ...
        const url = `/secretaria/api/filtrar?page=${page}&limit=${limit}`;
        console.log('url (C:/laragon/www/sgcpro/src/public/script/react_modelo_v1/frontend/src/services/secretaria.js):', url);
