// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\services\origem.js
...
// Serviço para gerenciar origem
const OrigemService = {

    getEndPoint: async () => {
        const url = '/origem/endpoint/salvar';
        let gov_br = [];
        let token_csrf = '';
        let getURI = [];
        try {
    ...
    getAll: async (page = 1, limit = 10) => {
        ...
        const url = `/origem/api/exibir?page=${page}&limit=${limit}`;
    ...
    getById: async (id) => {
        const url = `/origem/api/exibir/${id}`;
    ...
    postFilter: async (data, page = 1, limit = 10) => {
        ...
        const url = `/origem/api/filtrar?page=${page}&limit=${limit}`;
        // console.log('url (C:/laragon/www/sgcpro/src/public/script/react_modelo_v1/frontend/src/services/origem.js):', url);
    ...
    postSave: async (data) => {
        ...
        const url = `/origem/api/cadastrar`;
        // console.log('url (C:/laragon/www/sgcpro/src/public/script/react_modelo_v1/frontend/src/services/origem.js):', url);
