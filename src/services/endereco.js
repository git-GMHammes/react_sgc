...
const EnderecoService = {
    ...
    getEndPoint: async () => {
        const url = '/endereco/endpoint/salvar';
        let gov_br = [];
        let token_csrf = '';
        let getURI = [];
        try {
    ...
    getAll: async (page = 1, limit = 10) => {
        ...
        const url = `/endereco/api/exibir?page=${page}&limit=${limit}`;
    ...
    getById: async (id) => {
        const url = `/endereco/api/exibir/${id}`;
    ...
    postFilter: async (data, page = 1, limit = 10) => {
        ...
        const url = `/endereco/api/filtrar?page=${page}&limit=${limit}`; 
    ...
    postSave: async (data) => {
        ...
        const url = `/endereco/api/cadastrar`;
