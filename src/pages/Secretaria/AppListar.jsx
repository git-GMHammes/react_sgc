// C:\laragon\www\sgcpro\src\public\script\react_modelo_v1\frontend\src\pages\Secretaria\AppListar.jsx
...
const AppListar = () => {
    ...
    const submitAllForms = (filtroForm) => {
        ...
        switch (filtroForm) {
            ...
            case 'filtro-filtro-limpar':
                ...
                // setValue('cad_cnpj_cpf', 'gustavo@gmail.com');
                // setValue('tel_numero', null);
                // setValue('email_email', null);
                break;
            default:
    ...
    const fetchEndpointSecretaria = async () => {
        try {
            ...
            // console.log('fetchEndpointSecretaria ::', response); 
    ...
    const fetchSecretaria = async (page = 1, limit = 10) => {
        try {
            setLoading(true);
            ...
            console.error('Erro secretarias:', err);
            setLoading(false);
        }
    };
    ...
    const fetchFilter = async (data, page = 1, limit = 10) => {
        try {
            ...
            const response = await SecretariaService.postFilter(data, page, limit);
    ...
    useEffect(() => {
        ...
        const initializeData = async () => {
            try {
                ...
                await fetchSecretaria(page, limit);
            ...
            <div className="row g-2 justify-content-start w-100">
                <div className="col-12 col-sm-2">
                    <form
                        ...
                        onSubmit={(e) => {
                            e.preventDefault();
                            submitAllForms(`filtro-filtro-secretaria`);
                        }}>
                        <input
    ...
    const renderBtnFiltro = () => {
        return (
            <div className='d-flex justify-content-end w-100'>
                <div>
                    <BlurInModal
                        idModal="modal-secretaria"
                        buttonName="Cadastrar"
                        strTitleModal="Cadatrar Secretaria"
                        isOpenInitial={false}
                    >
